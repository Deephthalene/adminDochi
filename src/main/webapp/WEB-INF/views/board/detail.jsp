					...
					<div class="col-lg-8 m-15px-tb">
						<article class="article">
							<div class="article-title">
								<h2 id="title" name="uid" readonly>${board.title}</h2>
								<div class="media">
									<div class="avatar">
									...
									<div class="media-body">
										<label>${board.created_user }</label> <span>${board.created_at }</span>
									</div>
								</div>
							</div>
							...
							<div class="nav tag-cloud">
								<a href="/board/remove?uid=${board.uid }">글 삭제</a> <a
									href="/board/modify">글 수정하기</a>
							</div>
				<!-- comment line -->
							...
							<div class="card-body">
								...
								<div class="d-flex justify-content-between">
									<div class="d-flex flex-row align-items-center">
										...
										<p class="small mb-0 ms-2">abcd</p>
									</div>
									<div class="d-flex flex-row align-items-center">
